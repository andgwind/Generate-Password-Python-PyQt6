...
from PyQt5.QtWidgets import (QAbstractSpinBox, QFrame, QHBoxLayout, QLabel,
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Generate Password", None))
